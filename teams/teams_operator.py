...
class TeamsOperator(SimpleHttpOperator):
    """
    ...
    template_fields = ('message', 'subtitle', 'theme_color', 'button_url')
    ...
    def __init__(self,
        ...
        super(TeamsOperator, self).__init__(endpoint=webhook_token, *args, **kwargs)
        self.http_conn_id = http_conn_id
